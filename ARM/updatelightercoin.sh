...
wget https://github.com/minblock/litecoin/releases/download/v0.18.1-rc/litecoin-0.18.1-arm-linux-gnueabihf.tar.gz
echo "b3b5faea45b6c61da036bdfbd7a5b2a7a66fcdf54374ca95ae02106348d9057b litecoin-0.18.1-arm-linux-gnueabihf.tar.gz" | sha256sum -c
